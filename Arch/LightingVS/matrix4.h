...
inline Cvec4f multiply(const Matrix4& m, const Cvec4f& c) {
	return Cvec4f(m(0, 0)*c(0) + m(0, 1)*c(1) + m(0, 2)*c(2) + m(0, 3)*c(3),
		m(1, 0)*c(0) + m(1, 1)*c(1) + m(1, 2)*c(2) + m(1, 3)*c(3),
		m(2, 0)*c(0) + m(2, 1)*c(1) + m(2, 2)*c(2) + m(2, 3)*c(3),
		m(3, 0)*c(0) + m(3, 1)*c(1) + m(3, 2)*c(2) + m(3, 3)*c(3));
}

inline Cvec3f transform4to3(const Cvec4f& c) {
	return Cvec3f(c(0), c(1), c(2));
}
