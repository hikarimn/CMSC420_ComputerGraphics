...
static void animatecubes(int) {
	
	glutPostRedisplay();
	glutTimerFunc(1000.0 / 60.0, animatecubes, 0);
}
static void keyboard(const unsigned char key, const int x, const int y) {
	...
	case 'o':
		...
		break;
	case 'd':
		glutTimerFunc(25, animatecubes, 1);
		break;
		//Use this quat class and its power operator to implement a feature that causes both cubes to appear to spin back to their original orientations when the user presses the 'd' key on the keyboard. 
		//To implement the spinning animation you can use the function glutTimerFunc to schedule an animate function to run after a delay of a certain number of milliseconds.
		//In that animate function you will rotate each cube by a tiny amount along the interpolation, call glutPostRedisplay to redraw the scene, and then potentially call glutTimerFunc again to schedule the next frame in the animation.
